...
class Quarto(object):
    ...
    def __init__(self) -> None:
        ...
        self.__current_player = random.randint(0, 1) # randomly choose the first player to move
        self.__players = ()
    ...
    def run(self, output_enabled:bool=False) -> int:
        '''
    ...
    def reset(self) -> None:
        ''' 
        Reset the board and other variables 
        '''
        self.__board = np.ones(shape=(self.BOARD_SIDE, self.BOARD_SIDE), dtype=int) * -1
